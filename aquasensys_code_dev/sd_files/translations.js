const translations = {
  en: {
    ...
    "toggleMainSwitch": "Toggle Main Switch",
    ...
    "systemDebugTitle": "System Debug & Hardware Diagnostics",
    "debugWarning": "Debug Mode",
    "debugWarningText": "This page shows raw hardware values and system internals for troubleshooting. All values update in real-time.",
    "sdCardStatus": "SD Card Status",
    "cardDetected": "Card Detected",
    "cardType": "Card Type",
    "cardSize": "Card Size",
    "filesCount": "Files Count",
    "mcpStatus": "MCP3208 ADC Status",
    "mcpInitialized": "Initialized",
    "mcpVref": "Reference Voltage",
    "mcpReadErrors": "Read Errors",
    "spiStatus": "SPI Status",
    "rawAdcValues": "Raw ADC Values (0-4095)",
    ...
    "voltage": "Voltage",
    "processedValues": "Processed Sensor Values",
    "calibrationOffsets": "Calibration Offsets",
    "pressureInOffset": "Pressure In Offset",
    "pressureOutOffset": "Pressure Out Offset",
    "currentL1Offset": "Current L1 Offset",
    "currentL2Offset": "Current L2 Offset",
    "currentL3Offset": "Current L3 Offset",
    "freeHeap": "Free Heap",
    "resetReason": "Reset Reason",
    "cpuFreq": "CPU Frequency",
    "wifiStatus": "WiFi Status",
    "wifiConnected": "Connected",
    "wifiRssi": "Signal (RSSI)",
    "mqttStatus": "MQTT Status",
    "mqttConnected": "Connected",
    "mqttServer": "Server",
    "lastMqttMsg": "Last Message",
    "motorControl": "Motor & Control State",
    "motorState": "Motor",
  ...
  pt: {
    ...
    "toggleMainSwitch": "Alternar Interruptor Principal",
    ...
    "systemDebugTitle": "Depuração do Sistema & Diagnósticos de Hardware",
    "debugWarning": "Modo de Depuração",
    "debugWarningText": "Esta página mostra valores brutos de hardware e informações internas do sistema para resolução de problemas. Todos os valores são atualizados em tempo real.",
    "sdCardStatus": "Estado do Cartão SD",
    "cardDetected": "Cartão Detetado",
    "cardType": "Tipo de Cartão",
    "cardSize": "Tamanho do Cartão",
    "filesCount": "Contagem de Ficheiros",
    "mcpStatus": "Estado do MCP3208 ADC",
    "mcpInitialized": "Inicializado",
    "mcpVref": "Tensão de Referência",
    "mcpReadErrors": "Erros de Leitura",
    "spiStatus": "Estado SPI",
    "rawAdcValues": "Valores ADC Brutos (0-4095)",
    "currentL1": "Corrente L1",
    "currentL2": "Corrente L2",
    "currentL3": "Corrente L3",
    "unused": "Não utilizado",
    "voltageReadings": "Leituras de Tensão",
    "voltage": "Tensão",
    "processedValues": "Valores Processados dos Sensores",
    "calibrationOffsets": "Offsets de Calibração",
    "pressureInOffset": "Offset Pressão Entrada",
    "pressureOutOffset": "Offset Pressão Saída",
    "currentL1Offset": "Offset Corrente L1",
    "currentL2Offset": "Offset Corrente L2",
    "currentL3Offset": "Offset Corrente L3",
    "freeHeap": "Memória Livre",
    "resetReason": "Razão do Reinício",
    "cpuFreq": "Frequência do CPU",
    "wifiStatus": "Estado WiFi",
    "wifiConnected": "Conectado",
    "wifiRssi": "Sinal (RSSI)",
    "mqttStatus": "Estado MQTT",
    "mqttConnected": "Conectado",
    "mqttServer": "Servidor",
    "lastMqttMsg": "Última Mensagem",
    "motorControl": "Estado do Motor & Controlo",
    "motorState": "Motor",
